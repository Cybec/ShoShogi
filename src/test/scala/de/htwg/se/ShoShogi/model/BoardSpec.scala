  ...
  "A Board is the playingfield of Shogi. A Board" when {
    ...
    "using an actuall playfield" should {
      ...
      "replace cells with Pieces" in {
        ...
        board.board(0)(1) should be(Knight(player_1))
        board.board(0)(2) should be(SilverGeneral(player_1))
        board.board(0)(3) should be(GoldenGeneral(player_1))
        board.board(0)(4) should be(King(player_1))
        board.board(0)(5) should be(GoldenGeneral(player_1))
        board.board(0)(6) should be(SilverGeneral(player_1))
        board.board(0)(7) should be(Knight(player_1))
        board.board(0)(8) should be(Lancer(player_1))
        board.board(1)(1) should be(Bishop(player_1))
        board.board(1)(7) should be(Rook(player_1))
        board.board(2)(0) should be(Pawn(player_1))
        board.board(2)(8) should be(Pawn(player_1))
      }
