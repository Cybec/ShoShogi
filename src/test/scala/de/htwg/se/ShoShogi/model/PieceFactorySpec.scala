  ...
  "A PieceFactory" when {
    "called apply" should {
      ...
      "create King for given PiecesEnum.King" in {
        val king = PieceFactory.apply(PiecesEnum.King, player_1)
      ...
      "create GoldenGeneral for given PiecesEnum.GoldenGeneral" in {
        val goldenGeneral = PieceFactory.apply(PiecesEnum.GoldenGeneral, player_1)
      ...
      "create SilverGeneral for given PiecesEnum.SilverGeneral" in {
        val silverGeneral = PieceFactory.apply(PiecesEnum.SilverGeneral, player_1)
      ...
      "create PromotedSilver for given PiecesEnum.PromotedSilver" in {
        val promotedSilver = PieceFactory.apply(PiecesEnum.PromotedSilver, player_1)
      ...
      "create Knight for given PiecesEnum.Knight" in {
        val knight = PieceFactory.apply(PiecesEnum.Knight, player_1)
      ...
      "create PromotedKnight for given PiecesEnum.PromotedKnight" in {
        val promotedKnight = PieceFactory.apply(PiecesEnum.PromotedKnight, player_1)
      ...
      "create PromotedLancer for given PiecesEnum.PromotedLancer" in {
        val promotedLancer = PieceFactory.apply(PiecesEnum.PromotedLancer, player_1)
      ...
      "create Bishop for given PiecesEnum.Bishop" in {
        val bishop = PieceFactory.apply(PiecesEnum.Bishop, player_1)
      ...
      "create PromotedBishop for given PiecesEnum.PromotedBishop" in {
        val promotedBishop = PieceFactory.apply(PiecesEnum.PromotedBishop, player_1)
      ...
      "create Rook for given PiecesEnum.Rook" in {
        val rook = PieceFactory.apply(PiecesEnum.Rook, player_1)
      ...
      "create PromotedRook for given PiecesEnum.PromotedRook" in {
        val promotedRook = PieceFactory.apply(PiecesEnum.PromotedRook, player_1)
      ...
      "create PromotedPawn for given PiecesEnum.PromotedPawn" in {
        val promotedPawn = PieceFactory.apply(PiecesEnum.PromotedPawn, player_1)
      ...
      "create EmptyPiece for given PiecesEnum.EmptyPiece" in {
        val emptyPiece = PieceFactory.apply(PiecesEnum.EmptyPiece, player_1)
