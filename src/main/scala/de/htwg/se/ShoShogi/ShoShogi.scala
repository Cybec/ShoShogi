...
object ShoShogi extends ControllerInterface {
  val boardSize = 9
  val controller: ControllerInterface = createController(new Board(boardSize, new EmptyPiece), Player("Player1", true), Player("Player2", false))
